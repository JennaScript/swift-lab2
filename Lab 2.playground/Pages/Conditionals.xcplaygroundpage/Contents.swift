...
let response3 = stringToEmojis(word: "laughing")
let response4 = stringToEmojis(word: "cool")
let response5 = stringToEmojis(word: "awesome")
let response6 = stringToEmojis(word: "sad")
...
let response7 = stringToNewEmojis(word: "happy")
let response8 = stringToNewEmojis(word: "good")
let response9 = stringToNewEmojis(word: "okay")
let response10 = stringToNewEmojis(word: "awesome")
let response11 = stringToNewEmojis(word: "lit")
let response12 = stringToNewEmojis(word: "fun")
let response13 = stringToNewEmojis(word: "laughing")
let response14 = stringToNewEmojis(word: "cool")
let response15 = stringToNewEmojis(word: "bummed")
