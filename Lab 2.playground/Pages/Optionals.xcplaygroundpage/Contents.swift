...
print(username)
let String = username ?? "Jenna"
print(username)
print(username)

if let username = String? {
    print("username contains a value, and it is \(String)")
} else {
    print("username does not contain a value")
}

// I'm not quite sure if the above code is correct! I would love some feedback on how to complete this challenge correctly! If possible! Thank you :)
